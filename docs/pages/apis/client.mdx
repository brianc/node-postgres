...
```js
const escapedIdentifier = client.escapeIdentifier('FooIdentifier')
...
```js
const { Client } = require('pg')
const escapedIdentifier = Client.prototype.escapeIdentifier('Bar"Identifier')
console.log(escapedIdentifier) // '"Bar""Identifier"'
```
