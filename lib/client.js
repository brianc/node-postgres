...
Client.prototype.connect = function(callback) {
  ...
  // if connection drops while query is being executed, forward an error to the query
  con.on('end', function() {
    self.emit('end');
    if(self.activeQuery) {
      self.activeQuery.handleError(new Error('Connection was dropped while attempting to execute a query!'));
      self.activeQuery = null;
    }
  });
