...
Query.prototype.cancel = function () {
  ...
  if (runningClient.activeQuery === this) {
    ...
    connection.on('connect', () => connection.cancel(this.client.processID, this.client.secretKey))
  } else if (runningClient.queryQueue.indexOf(this) !== -1) {
    runningClient.queryQueue.splice(runningClient.queryQueue.indexOf(this), 1)
  }
}
