...
var Query = function(config, values, callback) {
  ...
  // Create promise here for ensure that events will be caught.
  // See https://github.com/brianc/node-postgres/issues/1292
...
Query.prototype.then = function(onSuccess, onFailure) {
  return this._promise.then(onSuccess, onFailure);
};
