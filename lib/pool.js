    ...
    pool = genericPool.Pool({
      ...
      create: function(cb) {
        ...
        client.connect(function(err) {
          ...
          client.poolCount = 0;
          //Should return client object in event emission?
    ...
    pool.connect = function(cb) {
      ...
      pool.acquire(function(err, client) {
        ...
        if(client.poolCount === 0){
            //If one wanted to know specifically whether the connection a pool is using
            //is new or not, the event would go here.
        }
