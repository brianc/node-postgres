...
var pools = {
  ...
  getOrCreate: function(clientConfig) {
    ...
    pool = genericPool.Pool({
      name: name,
      max: clientConfig.poolSize || defaults.poolLog,
      idleTimeoutMillis: clientConfig.poolIdleTimeout || defaults.poolLog,
      reapIntervalMillis: clientConfig.reapIntervalMillis || defaults.poolLog,
