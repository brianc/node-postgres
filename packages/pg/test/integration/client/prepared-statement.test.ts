...
describe('prepared-statement', () => {
  ...
  ;(function () {
    ...
    it('first named prepared statement', async function () {
    ...
    it('second named prepared statement with same name & text', async function () {
      const client = helper.client()
      await helper.createPersonTable(client)
      return new Promise((resolve) => {
    ...
    it('with same name, but without query text', async function () {
      const client = helper.client()
      await helper.createPersonTable(client)
    ...
    it('with same name, but with different text', async function () {
      const client = helper.client()
      await helper.createPersonTable(client)
      // First, register the named statement
      await new Promise((resolve) => {
  ...
  ;(function () {
    ...
    it('client 1 execution', async function () {
    ...
    it('client 2 execution', async function () {
  ...
  ;(function () {
    ...
    it('with no data response and rows', async function () {
