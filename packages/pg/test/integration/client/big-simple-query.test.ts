...
*/
  ...
  // Works
  it('big simple query 1', async function () {
  ...
  // Works
  it('big simple query 2', async function () {
    const client = helper.client()
    await helper.createPersonTable(client)
    return new Promise((resolve) => {
      client
  ...
  it('big simple query 3', async function () {
    const client = helper.client()
    await helper.createPersonTable(client)
    return new Promise((resolve) => {
      client
